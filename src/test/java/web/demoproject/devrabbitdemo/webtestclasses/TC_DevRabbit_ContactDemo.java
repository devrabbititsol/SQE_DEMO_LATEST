...
public class TC_DevRabbit_ContactDemo extends BaseClass {
	...
	public TC_DevRabbit_ContactDemo() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_DevRabbit_ContactDemo.class);
		configFileObj = new ConfigFilesUtility();
		configFileObj.loadPropertyFile("tc_devrabbit_contactdemo.properties");
	}
	...
	public void browserName(String browser) throws Exception {
		browserName = browser;
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath, ContactUsScreen.projectName);
		test = reports.startTest(setTestcaseName(browserName,"TC_DevRabbit_ContactDemo - " + datasetNames[0]));
	}

	
	public void setUP() throws Exception {
		String primaryInfo = ContactUsScreen.primaryInfo;
	...
	public void screensTest() throws Exception {
		for(int datasets = 1; datasets <= HomeScreen.datasetsLength; datasets++) {
			...
			setUP();			
			if(datasets > 1) { test = reports.startTest(setTestcaseName(browserName,"TC_DevRabbit_ContactDemo - " + datasetNames[datasets-1]));}
